...
---
### Executive Summary:
#### This exercise seeks to develop a machine learning model to predict  excercise qualtity using accelerometer measurements from 6 volunteer subjects during controlled excersises. Specifically, a random Forest classification model for predicting 5 possible levels of exercise quality (1 good, 4 bad) was developed using additional bootstrap aggregation beyond that which is intrinsic to Random Forest modeling - i.e. "double" bootstrap analysis. This is likely an overkill, but I got to learn the mechanics of bootstrapping. The aggregated model produced a 99% clasification accuracy with the training dataset. The model was applied to data acquired from 20 test cases and 100% of all the test cases were correctly classified by exercise quality.
